var bancoDePalavras = ["ONITORRINCO","MICROSOFT","JAVASCRIPT","AZUL","STROGONOFF","ROXO","FOGUETE"];
var listaDeLetras = [];
var letrasErrada = [];
var erros = 6;
...
function ganhaJogo() {
    ...
    var conteudo = document.createTextNode("Parabéns, Você acertou!!!.");
...
function fimDeJogo() {
    var elemento = document.getElementById("msg");
    var conteudo = document.createTextNode("Você errou, a palavra é " + palavraSorteada + ", tente novamente.");
    elemento.appendChild(conteudo);
